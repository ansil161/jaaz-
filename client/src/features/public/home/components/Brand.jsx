import { brand } from '@/features/public/data/site'
import { Lines, Rule, Figure, Counter, Rise, Magnetic, Drift } from '@/features/public/components/Motion'
        ...
        <div className="mt-16 grid gap-12 lg:grid-cols-12 lg:gap-14">
          ...
          <div className="lg:col-span-6 lg:col-start-7">
            ...
            <Rise className="mt-14" y={20}>
              <Magnetic>
                <Link to="/about" className="btn btn-on-paper focus-ring">
                  {brand.cta}
