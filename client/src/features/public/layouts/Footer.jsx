...
import { Drift, Lines, Rise } from '@/features/public/components/Motion'
      ...
      <div className="relative shell-wide">
        ...
        >
          ...
          <div data-col className="max-w-md md:col-span-2 lg:col-span-1">
            {/* The full supplied lockup — BRIO, the logotype and the
                "home theater systems" line — in its reverse colourway
                for the charcoal field. This is the one place on the
                site with the vertical room to run the tagline at a
                size it can actually be read, which is why the header
                carries the cropped mark and this carries the whole
                thing. `w-fit` keeps the hit area on the artwork rather
                than across the column. */}
            <Link to="/" className="focus-ring block w-fit" aria-label={`${footer.wordmark} — home`}>
              <img
                src="/jaz-logo-reverse.png"
                alt={footer.wordmark}
                width={860}
                height={594}
                loading="lazy"
                decoding="async"
                className="block h-20 w-auto sm:h-[5.5rem]"
              />
            </Link>
