...
import DocumentsPage from '@/features/admin/knowledge-base/pages/DocumentsPage'
import UploadPage from '@/features/admin/knowledge-base/pages/UploadPage'
import Shell from '@/features/admin/layouts/Shell'
import { titleFor } from '@/features/admin/layouts/navigation'
import Dashboard from '@/features/admin/dashboard/pages/DashboardPage'
